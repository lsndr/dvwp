...
test('GET /s3/us-east-1', { signal: AbortSignal.timeout(timeout) }, async () => {
  await runner
    .createScan({
    ...
    .run({
      ...
      headers: {
        ...
        'Authorization': 'AWS4-HMAC-SHA256 Credential=AKIAIOSFODNN7EXAMPLE/20231101/us-east-1/s3/aws4_request, SignedHeaders=host;x-amz-date, Signature=EXAMPLESIGNATURE'
      }
    });
});